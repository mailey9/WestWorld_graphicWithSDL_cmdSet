...
//
//
class SleepOnBedTilRested : public State<Miner>
{
private:
	SleepOnBedTilRested(){}

	//copy ctor and assignment should be private
	SleepOnBedTilRested(const SleepOnBedTilRested&);
	SleepOnBedTilRested& operator=(const SleepOnBedTilRested&);
...
//
//
class DeliverTissue : public State<Miner>
{
private:
	...
	//copy ctor and assignment should be private
	DeliverTissue(const DeliverTissue&);
	DeliverTissue& operator=(const DeliverTissue&);
