...
//const int ComfortLevel = 1;				// FOR DEBUGGING

//the amount of nuggets a miner can carry
const int MaxNuggets         = 3;
//const int MaxNuggets = 1;					// FOR DEBUGGING

//above this value a miner is thirsty
//const int ThirstLevel        = 5;
const int ThirstLevel = 800;
...
public:
  ...
  Miner(int id, ML_POSMat posMat) : m_Location(shack),
								  m_iGoldCarried(0),
								  m_iMoneyInBank(0),
								  m_iThirst(0),
								  m_iFatigue(0),
